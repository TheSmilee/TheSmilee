...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Architects+Daughter&color=0000ff&size=30&lines=Hola!+Soy+!+$mile,,!;Estoy+aprendiendo+programacion...;Soy+CEO+de+LX+Leaks;Sigo+haciendo+mas+proyectos+para+mejorar+y+ayudar;Contactame+para+contribuciones;Entra+a+LX+LEAKS+en+el+boton+de+discord)](https://git.io/typing-svg)
